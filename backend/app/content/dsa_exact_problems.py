...
DSA_EXACT_PROBLEMS: dict[str, dict] = {
    ...
    "dsa-algorithmic-thinking": {
        ...
        "problems": [
            ...
            ("plus-one", ["array", "math"],
             "Carry propagation: the cases have to be enumerated before any code is written."),
        ],
    },
    "dsa-big-o": {
        ...
        "problems": [
            ...
            ("missing-number", ["array", "hash-table", "math", "bit-manipulation", "sorting"],
             "Sort, hash, sum and XOR all solve it at different cost -- one problem, four complexities."),
        ],
    },
    "dsa-best-worst-average": {
        ...
        "problems": [
            ("binary-search", ["array", "binary-search"],
             "Best case is one comparison, worst is log n -- the distinction with nothing else attached."),
            ("find-the-index-of-the-first-occurrence-in-a-string", ["two-pointers", "string", "string-matching"],
             "Naive matching is O(n) on a lucky input and O(n*m) on a cruel one, from the same code."),
            ("contains-duplicate", ["array", "hash-table", "sorting"],
             "A hash set is O(1) average and O(n) worst per lookup -- average case you can actually feel."),
        ],
    },
    ...
    "dsa-array-frequency": {
        ...
        "problems": [
            ...
            ("find-all-numbers-disappeared-in-an-array", ["array", "hash-table"],
             "Counting by marking positions in the array itself, with no second structure."),
        ],
    },
    "dsa-array-patterns": {
